 ...
 */
import type { Child, JSXNode } from './base.d.ts';
import type { JSX } from './intrinsic-elements.d.ts';
export type { Child, JSXNode, FC } from './base.d.ts';
export type { RefObject } from './hooks/index.d.ts';
