import { GET_MATCH_RESULT } from './request/constants.d.ts';
import type { Result } from './router.d.ts';
import type { Input, InputToDataByTarget, ParamKeyToRecord, ParamKeys, RemoveQuestion, RouterRoute, ValidationTargets } from './types.d.ts';
import type { BodyData, ParseBodyOptions } from './utils/body.d.ts';
import type { CustomHeader, RequestHeader } from './utils/headers.d.ts';
import type { Simplify, UnionToIntersection } from './utils/types.d.ts';
type Body = {
    json: any;
    text: string;
