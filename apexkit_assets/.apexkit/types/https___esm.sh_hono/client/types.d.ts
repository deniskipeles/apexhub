...
import type { HonoBase } from '../hono-base.d.ts';
import type { METHODS, METHOD_NAME_ALL_LOWERCASE } from '../router.d.ts';
import type { Endpoint, ExtractSchema, KnownResponseFormat, ResponseFormat, Schema } from '../types.d.ts';
import type { StatusCode, SuccessStatusCode } from '../utils/http-status.d.ts';
import type { HasRequiredKeys } from '../utils/types.d.ts';
/**
