...
export default function RoadmapPage() {
    const [data, setData] = useState<{ groups: Record<string, any[]>, sortedQuarters: string[] } | null>(null);
    ...
    if (!data) return <div className="p-12 text-center text-muted">Failed to load roadmap</div>;
    ...
    return (
        <div className="p-6 md:p-12 max-w-[1400px] mx-auto min-h-screen">
            ...
            <RoadmapView groups={data.groups} sortedQuarters={data.sortedQuarters} />
