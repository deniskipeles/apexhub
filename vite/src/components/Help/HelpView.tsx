...
import { 
    ...
    Monitor, RefreshCw, Box, Copy, Check, Layout
} from 'lucide-react';
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full max-w-2xl">
                 {[
                    ...
                    { icon: Code, label: "Share Code", desc: "Demo your pattern." },
                     ...
                     <button type="button" key={i} onClick={onNew} className="p-4 rounded-xl border border-border bg-surface/50 hover:bg-surface hover:border-primary/30 transition-all text-left group">
        ...
        <div className="flex flex-col h-full">
            <div className="h-16 border-b border-border bg-background px-6 flex items-center justify-between shrink-0">
                ...
                <div className="flex items-center gap-2">
                     <button type="button" onClick={handleCopy} className="p-2 hover:bg-surface rounded-lg text-muted hover:text-foreground transition-colors" title="Copy Sandbox URL">
