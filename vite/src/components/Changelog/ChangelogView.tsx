...
import { GitCommit, Calendar, Tag, ArrowRight, Loader2 } from 'lucide-react';
        ...
        <div className="p-6 md:p-12 max-w-4xl mx-auto min-h-screen">
                            ...
                            <div key={release.id} className="relative pl-8 md:pl-12 group">
                                ...
                                <div className="flex flex-col md:flex-row md:items-center gap-4 mb-6">
                                    ...
                                    <div className="flex items-center gap-2 text-sm text-muted font-medium bg-surface px-3 py-1 rounded-full border border-border w-fit">
                                        <Calendar size={14} />
                                        {d.release_date ? new Date(d.release_date).toLocaleDateString(undefined, { year: 'numeric', month: 'long', day: 'numeric' }) : ''}
                                    </div>
                                </div>
            ...
            <div className="mt-16 text-center pt-12 border-t border-border">
                <p className="text-muted text-sm">
                    Want to contribute? Check out our <a href="https://github.com/apexkit" target="_blank" rel="noreferrer" className="text-primary hover:underline font-medium">GitHub Repository</a>.
                </p>
            </div>
        </div>
    );
