...
import { Bug, Lightbulb, ThumbsUp, Search, Plus, Loader2, X } from 'lucide-react';
  ...
  return (
    <div>
        <div className="flex flex-col sm:flex-row gap-4 justify-between mb-6 animate-in fade-in">
            ...
            <button type="button" onClick={() => setIsCreateOpen(true)} className="px-4 py-2 bg-primary text-white text-sm font-bold rounded-lg hover:bg-primary-hover flex items-center gap-2 whitespace-nowrap shadow-sm transition-colors">
