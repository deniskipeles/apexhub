    ...
    return (
        <div className="p-6 md:p-12 max-w-7xl mx-auto min-h-screen space-y-24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {/* 2. Database Strategy */}
                <div className="col-span-1 bg-surface/50 border border-border rounded-3xl p-8 flex flex-col justify-between hover:border-emerald-500/30 transition-colors">
                    <div>
                    ...
                    <div className="mt-8">
                        <div className="flex items-center gap-2 text-xs font-mono text-emerald-400 bg-emerald-500/5 px-3 py-2 rounded-lg border border-emerald-500/10">
                            <Split size={14} />
                ...
                {/* 3. Multi-Tenancy */}
                <div className="col-span-1 bg-surface/50 border border-border rounded-3xl p-8 hover:border-amber-500/30 transition-colors">
            ...
            <div className="bg-surface/30 border border-border rounded-3xl p-8 md:p-12">
                <div className="flex flex-col md:flex-row items-center gap-12">
                    <div className="flex-1 space-y-6">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-500 text-xs font-semibold tracking-wide uppercase">
                    ...
                    <div className="w-full md:w-1/2 flex flex-col gap-4">
                        ...
                        <div className="pl-8 space-y-2">
                             <div className="bg-background/80 border border-border/50 rounded-lg p-3 text-xs font-mono text-emerald-400">
                                &gt; Match: "Nike Air Zoom" (Score: 4.8)
                             </div>
                             <div className="bg-background/80 border border-border/50 rounded-lg p-3 text-xs font-mono text-amber-400">
